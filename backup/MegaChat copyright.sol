...
contract MegaChat {
    ...
    struct MessageMetadata {
        ...
        string contentHash;     // Encrypted message content
    ...
    // State variables
    mapping(address => string) public usernames;                // Optional usernames
    mapping(address => string) public publicKeys;               // User's public key for encryption
